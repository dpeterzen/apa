...
export function NavHeader() {
  ...
  return (
    <header className="sticky top-0 z-[51] bg-background/100 flex h-[48px] shrink-0 items-center px-[14px] backdrop-blur-sm right-0 left-0">
      <SidebarTrigger />
      <div className="flex-1 flex">
        {currentWall && (
          <WallTitle wallId={currentWall._id} title={currentWall.title} />
        )}
      </div>
